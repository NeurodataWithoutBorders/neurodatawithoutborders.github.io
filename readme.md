...
This is the source of [nwb.org](https://www.nwb.org). The site is built with [Hugo](https://gohugo.io/); see more starters at https://github.com/hugo-starters/.

Preview builds of pull requests are generated automatically by the Netlify GitHub App using @bendichter's Netlify account.

This website is meant as a community resource maintainable by the community. If you have a tool that integrates with NWB, an archive that accepts NWB files, an electronic course that teaches NWB, an NWB-related event, or similar content, feel free to create a PR directly on this repository. The rest of this file explains how.
...
This will start a local server on port 1313 (open `localhost:1313` in your browser). The site will automatically reload when you make changes.
...
See our dedicated guide: [Integrating Community Software with NWB](https://www.nwb.org/contributing-tools/)
...
- Join the [NWB Slack workspace](https://nwb-users.slack.com/join/shared_invite/zt-9bsx3xdj-wtUILLNzM8a0mOV_RywS~Q#/shared-invite/email)
- Contact us through the [Contact Us](https://www.nwb.org/contact-us/) page

### Code of Conduct

All contributors are expected to follow our [Code of Conduct](https://www.nwb.org/code_of_conduct/).
