---
title: "NeuroDataReHack 2026 Recordings Now Available"
weight: 1
date: "2026-07-23"
subtitle: "Seventeen recorded talks from NeuroDataReHack 2026, covering NWB, DANDI, analysis tools, and AI-assisted workflows, are now on YouTube."
image: "/images/events/hck_2x_2026-janelia-ndrh/ndrh_2026_banner.png"
tags: announcement, videos, neurdata-rehack, training
---

The recorded talks from [NeuroDataReHack 2026](/events/hck26-2026-janelia-ndrh/) are now available on YouTube. This was the fifth annual NeuroDataReHack, a week-long workshop hosted at the Janelia Research Campus of the Howard Hughes Medical Institute from July 12 to 17, 2026. Participants learned how to find, read, and analyze open neurophysiology datasets shared in the Neurodata Without Borders (NWB) format on the DANDI Archive, and they spent most of the week working on their own reanalysis projects.

## Watch the Talks

The [NeuroDataReHack 2026 playlist](https://www.youtube.com/playlist?list=PLEv3d3vCiZ20) collects the recorded talks from the event. The full schedule, with each talk linked to its recording, is on the [event page](/events/hck26-2026-janelia-ndrh/). The talks are grouped by topic below.
...
NeuroDataReHack focuses on generating new insights from existing neurophysiology data through secondary analysis. The workshop emphasizes analyzing data that is already in NWB format and available on DANDI, rather than converting new data. This lets participants validate findings across species and brain areas, apply analysis tools to established datasets, explore follow-up questions to published studies, and create educational content from open data.

## Get Involved

If you would like to work with the datasets and tools covered in these talks, the [DANDI Archive](https://dandiarchive.org) is a good place to start, and the [NWB YouTube channel](https://www.youtube.com/@NeurodataWithoutBorders) has recordings from previous events and tutorials. To hear about future NeuroDataReHack events and other NWB news, subscribe to our [mailing list](https://mailchi.mp/fe2a9bc55a1a/nwb-signup). More information about past and upcoming workshops is on our [events page](/events/).

---

*NeuroDataReHack 2026 was hosted by the Janelia Research Campus of the Howard Hughes Medical Institute, and organized by Benjamin Dichter.*
